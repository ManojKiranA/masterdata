...
class MasterDataBulkDataTest extends BaseTestCase
{
    /** @var array */
    ...
    public function setUp(): void
    {
        ...
        foreach ($this->defaultBulkData as $eachData):
            MasterData::create($eachData);
        endforeach;

        $this->masterData = MasterData::all();
    }

    /** @test */
    public function defaultDataCountMatchesWithCreatedModel()
    {
        $this->assertEquals(count($this->defaultBulkData), $this->masterData->count());
    }
    ...
    /** @test */
    public function isGettingOnlyInActiveRecords()
    {
    ...
    /** @test */
    public function isOnltGettingSpecificType()
    {
        $arrayGroupsWithCount = (new Collection($this->defaultBulkData))
    ...
    /** @test */
    public function isOnltGettingSpecificTypes()
    {
        $arrayGroupsWithCount = (new Collection($this->defaultBulkData))
                        ->groupBy('main_constant_name')
                        ->map
